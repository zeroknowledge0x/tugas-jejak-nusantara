...
echo "[1/5] luau-compile --only-parse (Luau syntax)"
...
echo "[2/5] selene check (lua51 std + Roblox globals)"
...
echo "[4/5] rojo build (place file)"
mkdir -p "$ROOT/build"
...
echo "[5/5] runtime smoke test (luau interpreter)"
